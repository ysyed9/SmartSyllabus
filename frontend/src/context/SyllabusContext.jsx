...
export const SyllabusProvider = ({ children }) => {
  ...
  const fetchSyllabi = async () => {
    ...
    try {
      const response = await axios.get(`${API_BASE_URL}/syllabi`)
  ...
  const fetchUpcomingAssignments = async () => {
    try {
      const response = await axios.get(`${API_BASE_URL}/calendar/upcoming`)
  ...
  const addSyllabus = async (syllabusData) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/syllabi`, syllabusData)
  ...
  const updateSyllabus = async (id, syllabusData) => {
    try {
      const response = await axios.put(`${API_BASE_URL}/syllabi/${id}`, syllabusData)
  ...
  const deleteSyllabus = async (id) => {
    try {
      await axios.delete(`${API_BASE_URL}/syllabi/${id}`)
  ...
  const uploadSyllabus = async (formData) => {
    try {
      const response = await axios.post(`${API_BASE_URL}/syllabi/upload`, formData, {
        headers: {
